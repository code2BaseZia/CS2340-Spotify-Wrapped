...
from .views import IndexView, SignUpView, LogInView, LinkTokenView, ResetPasswordView, ResetPasswordConfirmView, DeveloperContactView, FeedbackView, AccountView
